...
Also `yt-dlp` and `ffmpeg` too, if fail to install:
- download the latest release of [`yt-dlp`](https://github.com/yt-dlp/yt-dlp/releases) and [`ffmpeg (Windows)`](https://github.com/BtbN/FFmpeg-Builds/releases) or [`ffmpeg (macOS/Linux)`](https://github.com/ffmpeg/ffmpeg/releases).
- install both of them

And, make sure they're in `PATH` system environment variable.
...
![my qr code](https://img.lightshot.app/u-Z4lTbtT1qe8M99xRPx7A.png)
